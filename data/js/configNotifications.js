$(document).ready(function(){
    ...
    $('#testIRC').click(function(){
      
        var irc_server = $("#irc_server").val();
        var irc_server_password = $("#irc_server_password").val();
        /*var irc_server_encryption = $("#irc_server_encryption").val();*/
        var irc_server_encryption = "off"
        var irc_nickname = $("#irc_nickname").val();
        var irc_channel = $("#irc_channel").val();
        var irc_channel_key = $("#irc_channel_key").val();
  
        $.get("$sbRoot/home/testIRC", {'server': irc_server, 'password': irc_server_password, 'ssl': irc_server_encryption, 'nickname': irc_nickname, 'channel': irc_channel, 'channel_key': irc_channel_key
    });
